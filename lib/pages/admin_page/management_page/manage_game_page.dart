...
import 'package:turbo_market/dialogs/admin/create_game_modale.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                onChanged: (value) => game.price = double.tryParse(value.replaceAll(",", ".")) ?? 0,
  ...
  void updateGameManage(Game game) async {
    updateGame(game).then((res) => {
      ...
      if (imageChanged) {
        ...
        if (res) {
          setState(() {
            game.image = "https://obsolete-events.com/turbo-market/app/images/games/game${game.id}?random=${DateTime.now().millisecondsSinceEpoch}";
          }),
